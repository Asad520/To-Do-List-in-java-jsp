<html lang="en">
  ...
  <body class="invisible-scrollbar">
    ...
    String name = "", email = "", groups="";
      if (sess == null) {
        ...
        try{
          ...
          groups = request.getParameter("hidField");
          if(groups == null){
    ...
    <div id="toDo">
      <ul id="myUL">
        <h1> -<u><%out.println(groups +" Group:");%></u></h1>
        <%
          ...
          String query = "Select todo,status,priority from todos where email='" + email + "' and groups = '"+groups+"'";
